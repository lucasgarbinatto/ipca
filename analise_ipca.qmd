...
```{python}
#| label: grafico-2026
#| fig-cap: "Expectativas mensais de IPCA para 2026 (Mediana com intervalo Mín-Máx)"

# Extrair min/max para 2026
minimos_2026 = [expectativas.get(m, {}).get('minimo', 0) for m in meses_2026]
maximos_2026 = [expectativas.get(m, {}).get('maximo', 0) for m in meses_2026]

fig, ax = plt.subplots(figsize=(12, 5))

# Área de intervalo min-max
ax.fill_between(nomes_meses, minimos_2026, maximos_2026, alpha=0.2, color='#08082a', label='Intervalo Mín-Máx')

# Linha principal com marcadores
ax.plot(nomes_meses, taxas_2026, 'o-', color='#08082a', linewidth=2.5, markersize=8, 
        markerfacecolor='white', markeredgewidth=2, label='Mediana', zorder=3)

# Adicionar valores nos pontos
for i, val in enumerate(taxas_2026):
    ax.annotate(f'{val:.2f}%', (nomes_meses[i], val), textcoords="offset points", 
                xytext=(0, 10), ha='center', fontsize=9, fontweight='bold', color='#08082a')
...
ax.set_ylim(0, max(maximos_2026) * 1.25)
...
```{python}
#| label: grafico-2027
#| fig-cap: "Expectativas mensais de IPCA para 2027 (Mediana com intervalo Mín-Máx)"

# Extrair min/max para 2027
minimos_2027 = [expectativas.get(m, {}).get('minimo', 0) for m in meses_2027]
maximos_2027 = [expectativas.get(m, {}).get('maximo', 0) for m in meses_2027]

fig, ax = plt.subplots(figsize=(12, 5))

# Área de intervalo min-max
ax.fill_between(nomes_meses, minimos_2027, maximos_2027, alpha=0.2, color='#dfac16', label='Intervalo Mín-Máx')

# Linha principal com marcadores
ax.plot(nomes_meses, taxas_2027, 's-', color='#dfac16', linewidth=2.5, markersize=8, 
        markerfacecolor='white', markeredgewidth=2, label='Mediana', zorder=3)

# Adicionar valores nos pontos
for i, val in enumerate(taxas_2027):
    ax.annotate(f'{val:.2f}%', (nomes_meses[i], val), textcoords="offset points", 
                xytext=(0, 10), ha='center', fontsize=9, fontweight='bold', color='#dfac16')

ax.set_ylabel('IPCA Esperado (%)', fontsize=12)
ax.set_xlabel('Mês', fontsize=12)
ax.set_title('Expectativas Mensais de IPCA - 2027', fontsize=14, fontweight='bold', color='#08082a')
ax.set_ylim(0, max(maximos_2027) * 1.25)
...
```{python}
#| label: grafico-comparativo-linha
#| fig-cap: "Comparativo Mensal 2026 vs 2027"

fig, ax = plt.subplots(figsize=(12, 5))

# Linhas de ambos os anos
ax.plot(nomes_meses, taxas_2026, 'o-', color='#08082a', linewidth=2.5, markersize=8, 
        markerfacecolor='white', markeredgewidth=2, label='2026', zorder=3)
ax.plot(nomes_meses, taxas_2027, 's-', color='#dfac16', linewidth=2.5, markersize=8, 
        markerfacecolor='white', markeredgewidth=2, label='2027', zorder=3)

ax.set_ylabel('IPCA Esperado (%)', fontsize=12)
ax.set_xlabel('Mês', fontsize=12)
ax.set_title('Comparativo Mensal de Expectativas IPCA: 2026 vs 2027', fontsize=14, fontweight='bold', color='#08082a')
ax.set_ylim(0, max(max(taxas_2026), max(taxas_2027)) * 1.25)
...
# Expectativas como linha com pontos grandes
ax.plot(['2026', '2027'], [inf_2026, inf_2027], 'o-', color='#08082a', linewidth=3, 
        markersize=15, markerfacecolor='#dfac16', markeredgewidth=3, markeredgecolor='#08082a', zorder=5)

for ano, val in zip(['2026', '2027'], [inf_2026, inf_2027]):
    ax.annotate(f'{val:.2f}%', (ano, val), textcoords="offset points", 
                xytext=(0, 18), ha='center', fontsize=12, fontweight='bold', color='#08082a')
